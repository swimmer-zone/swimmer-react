        ...
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 830 290" id="logo">
            <defs>
                <linearGradient id="gradient_1" x1="0%" y1="0%" x2="0%" y2="100%">
                    <stop style={{stopColor: '#2c2ebc'}} offset="0" />
                    <stop style={{stopColor: '#7c7efc'}} offset="0.6">
            ...
            <polygon fill="url(#gradient_1)" stroke="#2c2ebc" filter="url(#dropshadow)" className="s"
                     points="10,110 110,110 110,130 50,130 50,140 110,140 110,190 90,210 10,210 10,190 50,190 50,170 10,170"/>
            <polygon fill="url(#gradient_2)" stroke="#2c2ebc" filter="url(#dropshadow)" className="w"
            ...
            <g className="i">
                <polygon style={{fill: '#00000080'}} stroke="#2c2ebc" points="280,45 285,40 295,40 300,45 295,58 300,65 280,65 285,58"/>
                <polygon style={{fill: '#00000080'}} stroke="#2c2ebc" points="280,70 300,70 300,85 280,85"/>
                <polygon style={{fill: '#00000080'}} stroke="#2c2ebc" points="280,90 300,90 300,105 280,105"/>
                <polygon fill="url(#gradient_1)" stroke="#2c2ebc" filter="url(#dropshadow)"
                         points="260,110 320,110 320,190 300,210 260,210"/>
            </g>
            <polygon fill="url(#gradient_3)" stroke="#2c2ebc" filter="url(#dropshadow)" className="m"
            ...
            <polygon fill="url(#gradient_2)" stroke="#2c2ebc" filter="url(#dropshadow)" className="m"
            ...
            <polygon fill="url(#gradient_1)" stroke="#2c2ebc" filter="url(#dropshadow)" className="e"
                     points="610,110 710,110 710,170 670,170 670,140 690,140 690,130 670,130 670,190 710,190 710,190 690,210 610,210"/>
            <polygon fill="url(#gradient_2)" stroke="#2c2ebc" filter="url(#dropshadow)" className="e"
