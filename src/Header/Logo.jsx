        ...
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 830 290" id="logo">
            <defs>
                <linearGradient id="gradient_1" x1="0%" y1="0%" x2="0%" y2="100%">
                    <stop style={darkPurple} offset="0"/>
                    <stop style={lightPurple} offset="0.6">
                        <animate attributeName="offset" dur="7s" values="0.7;0.4;0.7" repeatCount="indefinite"/>
                    </stop>
                    <stop style={purple} offset="1"/>
                </linearGradient>
            ...
            <g className="i">
                <polygon style={black} points="280,45 285,40 295,40 300,45 295,58 300,65 280,65 285,58"/>
                <polygon style={black} points="280,70 300,70 300,85 280,85"/>
                <polygon style={black} points="280,90 300,90 300,105 280,105"/>
